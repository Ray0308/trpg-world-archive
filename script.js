  ...
  return `
    <div class="pc-complete-hero-visual">
      <div class="pc-complete-flank-frame pc-complete-flank-frame--left" aria-hidden="true">
        <img src="images/cthulhu-pixel.gif" alt="" class="pc-complete-flank pc-complete-flank--pixel pc-complete-flank--left" width="96" height="96" decoding="async">
      </div>
      ...
      <div class="pc-complete-flank-frame pc-complete-flank-frame--right" aria-hidden="true">
        <img src="images/cthulhu-pixel.gif" alt="" class="pc-complete-flank pc-complete-flank--pixel pc-complete-flank--right" width="96" height="96" decoding="async">
      </div>
    </div>`;
}
